    ...
    <section className='bg-[#1f1f1f] h-[calc(100vh-5rem)] overflow-hidden'>
      <div className='flex items-center justify-between px-10 py-4'>
        ...
        <div className='flex items-center justify-around gap-4'>
          ...
          <button  onClick={()=>setStatus("progress")} className={`text-[#ababab] text-lg  ${status === "progress" && "bg-[#383838]"} bg-[##383838] rounded-lg px-5 py-2 font-semibold`}>In progress</button>
      ...
      <div className='px-16 py-4 flex flex-wrap gap-6 overflow-y-scroll h-[calc(100vh-5rem-5rem)]'>
     <OrderCard/>
     <OrderCard/>
     <OrderCard/>
     <OrderCard/>
